<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo url('/')?>"><?php echo trans('main.home')?></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          ...
          <li>
            <a class="nav-link" href="<?php echo url('lang?lang=en')?>"><?php echo trans('main.english')?></a>
          </li>
          <?php else: ?>
            <li>
              <a class="nav-link" href="<?php echo url('lang?lang=ar')?>"><?php echo trans('main.arabic')?></a>
            </li>
            <?php endif;?>
            </li>
        </li>
